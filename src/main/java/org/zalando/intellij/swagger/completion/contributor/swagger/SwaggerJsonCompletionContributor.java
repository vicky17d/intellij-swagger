...
import org.zalando.intellij.swagger.extensions.completion.swagger.SwaggerJsonCustomValueCompletionFactory;
    ...
    public void fillCompletionVariants(@NotNull CompletionParameters parameters, @NotNull CompletionResultSet result) {
        ...
        if (isMainSwaggerFile || isPartialSwaggerFile) {
            ...
            if (jsonTraversal.isKey(psiElement)) {
                ...
                for (SwaggerJsonCustomKeyCompletionFactory ep : SwaggerJsonCustomKeyCompletionFactory.EP_NAME.getExtensions()) {
                ...
                for (SwaggerJsonCustomValueCompletionFactory ep : SwaggerJsonCustomValueCompletionFactory.EP_NAME.getExtensions()) {
                    ep.from(completionHelper, result)
                            .ifPresent(ValueCompletion::fill);
                }
            }
